...
export const validateJobUpdateInput = withValidationErrors([
  body("vardas").optional().notEmpty().withMessage("Prašome įvesti vardą"),
  body("telefonas")
    .optional()
    .notEmpty()
    .withMessage("Prašome įvesti telefoną"),
  body("adresas").optional().notEmpty().withMessage("Prašome įvesti adresą"),
  body("jobStatus")
    .optional()
  ...
  body("weekDay")
    ...
    .isIn(["Mon", "Tue", "Wed", "Thu", "Fri", "Sat", null])
    .withMessage("Neteisinga savaitės diena"),
]);
